...
CLIENT_TARGETS = $(CLIENT_BUILD)/map.o $(CLIENT_BUILD)/tile.o $(CLIENT_BUILD)/player.o $(CLIENT_BUILD)/network.o $(CLIENT_BUILD)/interface.o $(CLIENT_BUILD)/controller.o
SERVER_TARGETS = 
...
client: map.o tile.o player.o network.o interface.o controller.o 
...
controller.o:
	$(CC) $(CFLAGS) -o $(CLIENT_BUILD)/controller.o -c $(CLIENT_SRC)/include/controller.cpp
